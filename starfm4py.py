...
def predict(fine_image_t0, coarse_image_t0, coarse_image_t1, shape=None):
    ...
    print("spec_dist.shape: {} temp_dist.shape: {} spat_dist.shape: {}".format(spec_dist.shape, temp_dist.shape, spat_dist.shape))
...
def starfm(fine_image_t0, coarse_image_t0, coarse_image_t1, profile=None, shape=None):
    print('Processing...')
